...
fusen::fill_description(
  ...
  fields = list(
    ...
    `Authors@R` = c(
      person("Jake", "Tufts", email = "jakestufts@aol.co.uk", role = c("aut", "cre"), comment = c(ORCID = "0009-0008-3798-8805"))
    )
  )
, overwrite = TRUE)
...
The datasets created in the `flat_save_data.Rmd` have still to be saved into the
...
vignette generated from `flat_save_data.Rmd` for this. This vignette contains all the
...
now saved inside the `data/` folder of the package, and are thus available to users
